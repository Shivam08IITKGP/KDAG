...
def test_scenario_1_new_graph():
    ...
    graph = load_existing_graph(test_book, test_character)
...
def test_scenario_2_incremental_new_nodes():
    ...
    add_triplets_to_graph(graph, initial_triplets)
    ...
    updated_graph = load_existing_graph(test_book, test_character)
...
def test_scenario_3_update_existing_edge():
    ...
    add_triplets_to_graph(graph, triplets1)
    ...
    add_triplets_to_graph(graph, triplets2)
    ...
    print("\n💾 Step 4: Save and reload again")
    save_graph(graph, test_book, test_character)
    final_graph = load_existing_graph(test_book, test_character)
